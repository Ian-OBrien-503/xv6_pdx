...
CS333_CFLAGS += -DCS333_P1 -DUSE_BUILTINS -DCS333_P2 -DCGETPROCS_TEST -DCTIME_TEST
CS333_UPROGS += _date _ps _time 
CS333_TPROGS += _testsetuid  _testuidgid _p2-test _testtest2
endif
...
CS333_UPROGS += _date _time _ps
CS333_TPROGS += _p2-test _testsetuid _testuidgid _p4-test _newp4-test
endif
